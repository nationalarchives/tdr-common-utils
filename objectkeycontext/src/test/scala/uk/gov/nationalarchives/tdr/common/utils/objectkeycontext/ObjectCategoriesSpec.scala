...
import uk.gov.nationalarchives.tdr.common.utils.objectkeycontext.ObjectCategories.{DryRunMetadata, FileChecks, Metadata, Records}
...
class ObjectCategoriesSpec extends AnyWordSpec with MockitoSugar {
  "ObjectCategories" should {
    "have the correct field values" in {
      ...
      FileChecks.id shouldEqual "filechecks"
    ...
    "return the correct 'object categories' based on input string" in {
      ...
      ObjectCategories.toObjectCategory("filechecks") shouldBe FileChecks
